...
HD_PWD='C:/Users/tbnrs/Documents/Development/hdl_group_project_sc/hdl_group_project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ip_integrator_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ip_integrator_wrapper.tcl
