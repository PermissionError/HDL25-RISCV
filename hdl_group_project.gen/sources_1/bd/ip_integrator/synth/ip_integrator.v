...
(* CORE_GENERATION_INFO = "ip_integrator,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=ip_integrator,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=9,numReposBlks=9,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=USER,da_ps7_cnt=1,synth_mode=Global}" *) (* HW_HANDOFF = "ip_integrator.hwdef" *) 
module ip_integrator
   (DDR_addr,
    DDR_ba,
    DDR_cas_n,
    DDR_ck_n,
  ...
  wire [12:0]bram_ctrl_dram_BRAM_PORTA_ADDR;
  wire [31:0]bram_ctrl_dram_BRAM_PORTA_DIN;
  wire [31:0]bram_ctrl_dram_BRAM_PORTA_DOUT;
  wire bram_ctrl_dram_BRAM_PORTA_EN;
  wire bram_ctrl_dram_BRAM_PORTA_RST;
  wire [3:0]bram_ctrl_dram_BRAM_PORTA_WE;
  wire [12:0]bram_ctrl_iram_BRAM_PORTA_ADDR;
  wire [31:0]bram_ctrl_iram_BRAM_PORTA_DIN;
  wire [31:0]bram_ctrl_iram_BRAM_PORTA_DOUT;
  wire bram_ctrl_iram_BRAM_PORTA_EN;
  wire bram_ctrl_iram_BRAM_PORTA_RST;
  wire [3:0]bram_ctrl_iram_BRAM_PORTA_WE;
  wire [31:0]memgen_dram_doutb;
  wire [31:0]memgen_iram_doutb;
  ...
  ip_integrator_axi_gpio_0_0 axi_gpio_0
  ...
  (* BMM_INFO_ADDRESS_SPACE = "byte  0x40000000 32 > ip_integrator memgen_dram" *) 
  (* KEEP_HIERARCHY = "yes" *) 
  ip_integrator_axi_bram_ctrl_1_0 bram_ctrl_dram
       (.bram_addr_a(bram_ctrl_dram_BRAM_PORTA_ADDR),
        .bram_en_a(bram_ctrl_dram_BRAM_PORTA_EN),
        .bram_rddata_a(bram_ctrl_dram_BRAM_PORTA_DOUT),
        .bram_rst_a(bram_ctrl_dram_BRAM_PORTA_RST),
        .bram_we_a(bram_ctrl_dram_BRAM_PORTA_WE),
        .bram_wrdata_a(bram_ctrl_dram_BRAM_PORTA_DIN),
        .s_axi_aclk(Net),
  ...
  (* BMM_INFO_ADDRESS_SPACE = "byte  0x42000000 32 > ip_integrator memgen_iram" *) 
  (* KEEP_HIERARCHY = "yes" *) 
  ip_integrator_axi_bram_ctrl_0_0 bram_ctrl_iram
       (.bram_addr_a(bram_ctrl_iram_BRAM_PORTA_ADDR),
        .bram_en_a(bram_ctrl_iram_BRAM_PORTA_EN),
        .bram_rddata_a(bram_ctrl_iram_BRAM_PORTA_DOUT),
        .bram_rst_a(bram_ctrl_iram_BRAM_PORTA_RST),
        .bram_we_a(bram_ctrl_iram_BRAM_PORTA_WE),
        .bram_wrdata_a(bram_ctrl_iram_BRAM_PORTA_DIN),
        .s_axi_aclk(Net),
  ...
  (* BMM_INFO_PROCESSOR = "arm > ip_integrator bram_ctrl_dram ip_integrator bram_ctrl_iram" *) 
  (* KEEP_HIERARCHY = "yes" *) 
  ip_integrator_processing_system7_0_0 processing_system7_0
