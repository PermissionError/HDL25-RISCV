...
#
# Generated by export_simulation on Fri Feb 20 22:17:19 +0100 2026
#
################################################################################
...
'-reset_run' switch to the './ip_integrator.sh' script.

./ip_integrator.sh -reset_run
...
./ip_integrator.sh -noclean_files

For more information on the script, please type './ip_integrator.sh -help'.
